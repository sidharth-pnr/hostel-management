...
- **Frontend:** React (Vite, TailwindCSS) located in `C:\Users\LENOVO\OneDrive\Desktop\Group 15\hostel-management`
...
- For backend changes in `C:\xampp\htdocs\hostel_room_api`, ensure explicit confirmation before modification.
- Always run npm test after modifying a file.
- Don't change any single word or name that display on pages
