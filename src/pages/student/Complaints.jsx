                ...
                <GlassCard p="p-0" className="flex flex-col hover:border-blue-500/30 transition-all duration-500 overflow-hidden">
                  <div className="p-8">
                    ...
                    <div className="flex gap-6 items-start mb-8">
                      <div className="w-16 h-16 rounded-2xl bg-slate-100 dark:bg-white/5 p-3 flex-shrink-0 flex items-center justify-center border border-slate-200 dark:border-white/10">
                        <img src={c.issue_image_url} alt={c.category} className="w-full h-full object-contain" />
                      </div>
                      <div className="bg-slate-50 dark:bg-white/5 p-6 rounded-3xl border border-slate-100 dark:border-white/5 flex-grow"><p className="text-sm font-bold text-slate-600 dark:text-slate-300 italic leading-relaxed">"{c.description}"</p></div>
                    </div>
