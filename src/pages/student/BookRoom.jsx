...
const BookRoom = () => {
  ...
  const requestRoom = async () => {
    ...
    if (studentStatus?.allocated_room_id && !requestReason.trim()) {
                    ...
                    <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-3xl rounded-[3rem] border border-slate-200 dark:border-white/10 shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:border-blue-500/30 flex flex-col h-full">
                      ...
                      >
                        ...
                        <span className="relative z-10">
                          {user?.account_status === 'PENDING' ? "Waiting for Approval" : (studentStatus?.allocated_room_id ? "Request Change" : "Book Room")}
                        </span>
        ...
        {selectedRoomForApply && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 md:p-12">
            ...
            <motion.div 
              ...
              className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[3rem] border border-slate-200 dark:border-white/10 shadow-2xl relative overflow-hidden"
            >
