        ...
        <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 py-4">
          <div className="w-full max-w-lg mx-auto space-y-6 animate-slide-up">
            <div className="space-y-3 text-center sm:text-left">
              <div className="flex items-center gap-3 px-3 py-1.5 bg-slate-50 dark:bg-slate-900 w-fit rounded-full border border-slate-100 dark:border-slate-800 mx-auto sm:mx-0"><Icons.Sparkles size={12} className="text-teal-500" /><span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Student Register</span></div>
            ...
            <div className="pt-6 border-t border-slate-50 dark:border-slate-900 text-center"><p className="text-[11px] font-bold text-slate-400">Already a Member? <Link to="/login" className="text-slate-900 dark:text-white font-black hover:underline decoration-2 underline-offset-4 ml-1">Sign In</Link></p></div>
          </div>
        </div>
        <div className="p-6 text-center"><p className="text-[8px] font-black uppercase tracking-[0.3em] text-slate-200 dark:text-slate-800">Campus Housing • Security Standard • Group 15</p></div>
      </div>
    </div>
  );
};
